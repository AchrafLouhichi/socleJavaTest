...
describe('Author e2e test', () => {
    ...
    it('should load Authors', () => {
        ...
        expect(authorComponentsPage.getTitle()).toMatch(/socleJavaApp.author.home.title/);
    ...
    it('should load create Author dialog', () => {
        ...
        expect(authorDialogPage.getModalTitle()).toMatch(/socleJavaApp.author.home.createOrEditLabel/);
